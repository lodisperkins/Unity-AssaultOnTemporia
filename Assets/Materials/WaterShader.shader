...
Shader "Shader Forge/WaterShader" {
    Properties {
        ...
        _WaveHeight ("WaveHeight", Range(0, 10)) = 0.5
        _Depth ("Depth", Range(0, 10)) = 0
        _FoamPower ("FoamPower", Range(0, 10)) = 0
        _WaveSpeed ("WaveSpeed", Range(0, 5)) = 1
        _WaveSpread ("WaveSpread", Range(0, 5)) = 0.3
        _WaveWidth ("WaveWidth", Range(0, 10)) = 10
        _WaveCount ("WaveCount", Range(0, 10)) = 10
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_5555 = (o.uv0+node_5287*float2(0.5,0.5));
...
////// Specular:
                ...
                float4 node_690 = _Time;
                float2 node_2599 = (i.uv0+node_690.g*float2(0.5,0.5));
                ...
                float node_2360 = (1.0 - saturate(node_5418));
                float node_2145 = 5.0;
                float3 node_1007 = saturate(((((node_2670*_FoamTexture_var.rgb)*node_2360)*_FoamPower)+pow(node_2360,node_2145)));
...
////// Specular:
                ...
                float node_4646 = saturate((saturate((sceneZ-partZ)/_Depth)/0.5*dot(viewDirection,i.normalDir)+0.5));
                float3 node_2670 = lerp(_ColorA.rgb,_ColorB.rgb,node_4646);
                float4 node_2085 = _Time;
                float2 node_2599 = (i.uv0+node_2085.g*float2(0.5,0.5));
                float4 _FoamTexture_var = tex2D(_FoamTexture,TRANSFORM_TEX(node_2599, _FoamTexture));
                float node_8422 = 0.0;
                float node_5418 = (node_8422 + ( (node_4646 - _FoamMin) * (1.0 - node_8422) ) / (_FoamMax - _FoamMin));
                float node_2360 = (1.0 - saturate(node_5418));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_2599 = (i.uv0+node_4875.g*float2(0.5,0.5));
                float4 _FoamTexture_var = tex2D(_FoamTexture,TRANSFORM_TEX(node_2599, _FoamTexture));
                float node_8422 = 0.0;
                float node_5418 = (node_8422 + ( (node_4646 - _FoamMin) * (1.0 - node_8422) ) / (_FoamMax - _FoamMin));
                float node_2360 = (1.0 - saturate(node_5418));
